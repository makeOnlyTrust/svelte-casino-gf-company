...
<div class="w-full">
  <div class="w-full flex items-center justify-between pb-[25px] mb-[30px] border-b border-white11 gap-[25px]">
    <div class="relative z-[99] w-full flex flex-col gap-[15px] max-w-[500px] mx-auto">
      ...
      <div
        class="cursor-pointer mx-auto mt-[15px] w-[178px] py-[13px] rounded-[7px] bg-blue text-white opacity-80 hover:opacity-100 text-center"
      >
        Confirm
      </div>
    </div>
  ...
  <div class="w-full flex-col flex items-center justify-between pb-[25px] gap-[25px]">
    <div class="flex flex-col gap-[6px] w-full max-w-[500px] mx-auto">
      ...
      <p class="leading-[20px] text-sm text-grayDark font-medium leading-[20px]">
        Download and install Google Authenticator. Enable Two-factor Authentication to protect your account from
        unauthorized access.
      </p>
    ...
    <div class="relative z-[99] w-full flex flex-col gap-[15px] max-w-[500px] mx-auto">
      ...
      <p class="leading-[20px] text-sm text-grayDark font-medium leading-[20px]">
        Write down this code, never reveal it to others. You can use it to regain access to your account if there is no
    ...
    <p class="text-sm text-black dark:text-white font-bold">Two-factor Authentication</p>
    <div
      class="cursor-pointer mx-auto w-[178px] py-[13px] rounded-[7px] bg-blue text-white opacity-80 hover:opacity-100 text-center"
    >
      Confirm
    </div>
  </div>
