...
<div class="w-full">
  <div
    class="w-full flex items-center justify-between pb-[25px] gap-[20px] border-b border-grayLight dark:border-white11"
  >
  ...
  <div class="w-full flex flex-col pb-[25px] border-b border-grayLight dark:border-white11">
    <p class="text-sm sm:text-base text-black dark:text-white font-medium mt-[25px] mb-[20px]">
      {$LL.FIAT_CURRENCY()}
    </p>
    ...
    >
      <label class="w-[48%] cursor-pointer">
        ...
        >
          ...
          <p class="text-black50 dark:text-white50 font-medium text-msm text">
            {$LL.LIGHT()}
          </p>
        </div>
      </label>
