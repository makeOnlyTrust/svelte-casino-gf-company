...
<div
  class="fixed right-0 md:w-auto w-full top-[80px] md:top-[85px] bg-white dark:bg-black border !border-t-[0px] border-grayLight4 dark:border-white5 z-[999999996] md:z-[999999996]"
>
  <div class="w-full md:w-[297px] h-[calc(100vh-86px)]">
    ...
    <div class="relative" style="height: 100%;max-height: 100%;">
      <div
        class="w-full flex items-start justify-start max-h-full overflow-auto scrollbar-hidden"
        style="height: calc(100% - 63px);"
      >
        <div class="w-full h-calc-100-minus-50 sm:h-full flex flex-col gap-[25px] relative px-[14px] py-[20px]" style="position: relative;">
          <Messages messages={messages} bind:messagesElement={messagesElement} />
          <SendForm
            bind:myMessageText={myMessageText}
