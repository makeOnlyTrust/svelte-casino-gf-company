...
<div
  id="profileModal"
  class="fixed translate-x-[50%] sm:translate-x-[auto] right-[50%] sm:right-[20px] w-[96%] sm:w-auto top-[80px] sm:top-[20px] z-[999999998] bg-white dark:bg-black rounded-[14px] overflow-hidden border border-white11"
>
