...
<div class="relative w-full" id="lang-select">
  <Btn
    label={sidebarOpen ? languages[checkedIndex].label : languages[checkedIndex].value}
    variant="select"
    ...
    className="w-full absolute w-full !bg-black dark:!bg-white5 dark:!border-white11 border {dropdownActive
      ? 'border-primary'
      : 'border-white-5'}"
